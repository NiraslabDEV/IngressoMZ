          ...
          <div className="mt-6">
            <div className="relative mb-4">
              ...
              <div className="relative flex justify-center text-xs text-gray-400">
                <span className="bg-white px-3">ou regista com Google</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                onClick={() =>
                  signIn("google", { callbackUrl: `/${locale}/buyer/tickets` })
                }
                className="flex items-center justify-center gap-2 border border-gray-300 rounded-xl py-2.5 text-xs font-medium text-gray-700 hover:bg-gray-50 transition-colors"
              >
                <GoogleIcon />
                Comprador
              </button>
              <button
                ...
                onClick={() =>
                  signIn("google", {
                    callbackUrl: `/${locale}/auth/setup-role?role=ORGANIZER`,
                  })
                }
                className="flex items-center justify-center gap-2 border border-orange-300 rounded-xl py-2.5 text-xs font-medium text-orange-700 hover:bg-orange-50 transition-colors"
              >
                <GoogleIcon />
                Organizador
              </button>
